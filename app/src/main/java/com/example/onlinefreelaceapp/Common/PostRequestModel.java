...
public class PostRequestModel {
    ...
    private String posttitle, postmobile, postcategory, postdesc, postbudget;
    ...
    public PostRequestModel(int id, String posttitle, String postmobile, String postcategory, int postyear, int postmonth, int postday, String postdesc, String postbudget) {
        this.id = id;
    ...
    public PostRequestModel(int postyear, int postmonth, int postday, String posttitle, String postmobile, String postcategory, String postdesc, String postbudget) {
        this.postyear = postyear;
        this.postmonth = postmonth;
        this.postday = postday;
        this.posttitle = posttitle;
